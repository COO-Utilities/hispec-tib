...
static const struct coo_cmd_spec command_specs[] = {
    ...
    CMD_HELP_ONLY("mems/<switchname>", NULL,
                  "mems/<switchname> [state=<A|B> duty_cycle=<0..1> cycle_ms=<ms> stopafter_s=<s>]",
                  "state required for effect; duty/cycle/stop fields optional",
    ...
    CMD_SPEC("split", splitting_get, splitting_set,
             COO_CMD_CLASS_DEFAULT, true,
             "split [channel=<yj|hk> ratio1=<0..1> ratio2=<0..1> cycle_ms=<ms> stopafter_s=<s>]",
             "channel, ratio1, and ratio2 are required for effect; cycle_ms and stopafter_s optional",
             "channel: yj,hk",
