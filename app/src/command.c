...
static const struct coo_cmd_spec command_specs[] = {
    ...
    CMD_SPEC_TIB_PREFIX("atten/calibrate/records", atten_calibration_records_get, NULL,
             ...
             "query retained binary calibration records; start defaults to 0 and advances by chunk header",
             "physical: dac1,dac2",
             "MQTT-only binary chunks expose retained fit input and residual diagnostics",
             COO_CMD_HELP_QUERY | COO_CMD_HELP_SERIAL_GUARD_QUERY),
    ...
    CMD_HELP_ONLY("atten/<name>/coeff", NULL,
	                  "atten/<name>/coeff [dac1={fvoa_50pct_mv,slope_inv_fvoa_mv,gain} dac2={...} persist=<bool>]",
